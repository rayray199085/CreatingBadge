...
//  CreatingBadge
//
//  Created by Stephen Cao on 14/10/19.
            ...
            Path{ path in
                ...
                HexagonParameters.points.forEach {
                    ...
                    path.addQuadCurve(to:
                        CGPoint(x: xOffset + width * $0.useWidth.1 * $0.xFactors.1,
                    y: height * $0.useHeight.1 * $0.yFactors.1), control: CGPoint(x: xOffset + width * $0.useWidth.2 * $0.xFactors.2,
